...
PACKAGED_OUTPUT_DIR = PACKAGED_RESOURCES / "examples" / "repeating_groups"
SOH = "\x01"
...
def main() -> int:
    ...
    print(
        "Wrote "
        f"{len(expected_files)} generated repeating-group sample files under "
...
def write_outputs(expected_files: dict[Path, str]) -> None:
    write_generated_files(expected_files, OUTPUT_DIR)
    write_generated_files(
