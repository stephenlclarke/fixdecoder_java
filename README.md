...
```text
Usage: fixdecoder [-hv] [--column] [--follow] [--header] [--info] [--nocounts]
                  [--nowrap] [--number] [--plain] [--secret] [--secret-files]
                  [--summary] [--trailer] [--validate] [--verbose] [--color
                  [=<colour>]] [--component[=<component>]] [--message
                  [=<message>]] [--tag[=<tag>]] [--delimiter=<delimiter>]
                  [--fix=<fixVersion>] [--pager=<pager>] [--paging=<paging>]
                  [--secret-dir=<secretDir>] [--style=<style>]
                  [--xml=<xmlFiles>]... [<files>...]
...
Pretty-print FIX log messages and inspect FIX dictionaries.
      ...
      --color, --colour[=<colour>]
                           Colour mode: yes, no, always, never, or auto.
  ...
  -h, --help               Show this help message and exit.
      ...
      --message[=<message>]
                           Show message definition by name or MsgType.
